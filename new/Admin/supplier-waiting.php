                        ...
                        <div class="col-sm-12">
                            <div class="page-header-title">
                                ...
                                <ol class="breadcrumb pull-right">
                                    ...
                                    <li class="active">Fournisseurs sur liste d'attente</li>
                                </ol>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Fournisseurs sur liste d'attente </h3>
                                </div>
                                    ...
                                    <table id="datatable-buttons" class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col">Statut marquage</th>
                                            </tr>
                                        </thead>
                                        ...
                                        <tbody>
                                            ...
                                            $query = "SELECT * FROM attente_marquage";
