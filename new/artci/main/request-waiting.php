        ...
        <div class="container-fluid">
                ...
                <div class="row clearfix">
                    <div class="col-lg-5 col-md-5 col-sm-12">
                        ...
                        <ul class="breadcrumb padding-0">
                            ...
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Marquage</a></li>
                            <li class="breadcrumb-item active">Demandes de marquage en attente</li>
                        </ul>
                    </div>
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>Demandes de marquage</strong> en attente</h2>
